...
let AuthService = class AuthService {
    constructor(couchDb, redis) {
        this.couchDb = couchDb;
        this.redis = redis;
    }
    getAccessSecret() { return process.env.JWT_ACCESS_SECRET || 'access123'; }
    getRefreshSecret() { return process.env.JWT_REFRESH_SECRET || 'refresh123'; }
