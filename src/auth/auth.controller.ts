import { Controller, Post, Body, Req, Res, UsePipes, ValidationPipe, HttpCode, HttpStatus } from '@nestjs/common';
...
export class AuthController {
  ...
  @HttpCode(HttpStatus.OK)
  @UsePipes(new ValidationPipe())
  async login(@Body() dto: RegisterDto, @Req() req: Request, @Res({ passthrough: true }) res: Response) {
